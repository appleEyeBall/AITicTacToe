...
/**
 * This class is used to read in a state of a tic tac toe board. It creates a ExpertAlgorithm.MinMax object and passes the state to it. What returns is a list
